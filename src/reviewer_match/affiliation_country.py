...
# Every assignable code: the full ISO 3166-1 alpha-2 list, not just the countries
# COUNTRY_NAMES happens to spell. The two serve different jobs -- COUNTRY_NAMES
# parses free text and stays curated, while this validates a code someone wrote
# down by hand or a ccTLD. Deriving it from COUNTRY_NAMES made the hand layer
# unable to express a country the text parser had no name for (Turkey, Sri
# Lanka, ...), and quietly refused those ccTLDs too.
