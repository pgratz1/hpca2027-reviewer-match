"""Cross-check every reserve reviewer's DBLP identity against independent evidence.
    ...
    python audit_reserve_identities.py
    python audit_reserve_identities.py --out /tmp/audit.csv
...
from resolve_trc_members import (
    affiliation_tokens, author_name, index_self_declared_pids, tokens_compatible,
)

DEFAULT_INFO = "reserve_reviewer_info.csv"
DEFAULT_DATA = "hpca2027-data.json"
DEFAULT_PROFILES = "dblp_profile_cache.json"
DEFAULT_SENIORITY = "reserve_seniority.csv"
DEFAULT_OUT = "reserve_identity_audit.csv"
