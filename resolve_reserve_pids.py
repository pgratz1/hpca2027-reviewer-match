...
VERIFY=--verify`, and the person joins the roster.
    ...
    python resolve_reserve_pids.py --no-network      # cached lookups only
    python resolve_reserve_pids.py --out /tmp/dry-run.csv
"""
...
from dblp import name_tokens, parse_pid, split_dblp_field
...
DEFAULT_OUT = "reserve_dblp_overrides.csv"
