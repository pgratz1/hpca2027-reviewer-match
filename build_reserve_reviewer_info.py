...
grown HotCRP export produces a readable diff.
  ...
  shared_pid     two uploaded emails claim one PID. Either one is wrong, or one
    ...
    python build_reserve_reviewer_info.py
    python build_reserve_reviewer_info.py --verify     # check PIDs against DBLP
    python build_reserve_reviewer_info.py --out /tmp/dry-run.csv
"""
...
from dblp import name_tokens, parse_pid

DEFAULT_UPLOAD = "reserve_reviewer_upload.csv"
DEFAULT_VETTING = "reserve_reviewers_vetting_final.xlsx"
DEFAULT_SHEET = "All"
DEFAULT_OUT = "reserve_reviewer_info.csv"
DEFAULT_UNRESOLVED = "reserve_reviewer_unresolved.csv"
DEFAULT_OVERRIDES = "reserve_dblp_overrides.csv"
