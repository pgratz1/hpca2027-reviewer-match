"""Cache DBLP publication DOIs and abstracts for reviewer profiles.
    ...
    python -m scripts.enrich_publications --limit 10
    S2_API_KEY=... python -m scripts.enrich_publications
...
from reviewer_match.dblp import fetch_doi_records, normalise_doi
