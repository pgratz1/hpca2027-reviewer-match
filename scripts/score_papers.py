"""Fingerprint each paper and rank reviewers against it by SPECTER2 similarity.
    ...
    python -m scripts.score_papers                # every paper in hpca2027-data.json
    python -m scripts.score_papers --pid 8         # just one paper
    python -m scripts.score_papers --top 15
...
from reviewer_match.paper_matching import PAPER_POLICIES, build_paper_fingerprints, eligible_scores, load_papers
