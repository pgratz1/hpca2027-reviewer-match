"""Score completed blinded ratings for the abstract-enrichment experiment.
    ...
    python -m scripts.score_abstract_evaluation \
      --ratings outputs/evaluations/abstract-evaluation-ratings.csv \
      --key outputs/evaluations/abstract-evaluation-key.csv
...
def main() -> int:
    ...
    parser.add_argument(
        "--ratings", default=evaluation_path("abstract-evaluation-ratings.csv")
    )
    parser.add_argument("--key", default=evaluation_path("abstract-evaluation-key.csv"))
