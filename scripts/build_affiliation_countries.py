"""Enumerate every affiliation string and resolve which country it is in.
    ...
    python -m scripts.build_affiliation_countries
    python -m scripts.build_affiliation_countries --role reviewer --role reserve
    python -m scripts.build_affiliation_countries --validate CN=china_faculty.csv \
