"""Reviewer DBLP title fetcher — prints each reviewer's recent paper titles.
    ...
    python -m scripts.main --limit 5         # validate on a handful first
    python -m scripts.main                   # full run
    python -m scripts.main --years 2         # narrower window
...
from reviewer_match.dblp import fetch_titles_for_pids, load_cache, load_colleague_cache
