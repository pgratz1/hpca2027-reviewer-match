"""Print each reviewer's top-N most similar other reviewers by fingerprint.
    ...
    python -m scripts.nearest_neighbors                          # every reviewer
    python -m scripts.nearest_neighbors --email someone@example.com # just one
    python -m scripts.nearest_neighbors --top 10
