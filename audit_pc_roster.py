"""Cross-check the reviewer rosters against the HotCRP user export.
    ...
    python audit_pc_roster.py
    python audit_pc_roster.py --pcinfo hpca2027-pcinfo.csv
    python audit_pc_roster.py --pruned pc_roster_pruned.csv --missing pc_roster_missing.csv
...
from build_reserve_reviewer_info import DEFAULT_UPLOAD, write_csv
from pc_membership import local_part, on_pc, token_set
from reviewers import _latest_rows_by_email, field, load_reviewers

DEFAULT_PRUNED = "pc_roster_pruned.csv"
DEFAULT_MISSING = "pc_roster_missing.csv"
