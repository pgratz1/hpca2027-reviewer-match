"""Build a smaller paper export for smoke-testing the assignment end to end.
    ...
    python make_smoke_dataset.py --fraction 0.25       # tighter, less headroom
    python make_smoke_dataset.py --seed 7 --out /tmp/other-draw.json
...
DEFAULT_OUT = "hpca2027-data-smoke.json"
